...
<A> в общем похуй
~
A> не сон хуйня какбы
<A> но если брать то что соль все время разная
<A> и ты не знаешь соли
<A> а она добавляется
<A> а строка уменьшается
<A> так как если не будет соли
<A> можно расчитать следующее
<A> и это нихуя не безопасно
<A> в общем хуйня
<A> идея, но хуиту написал
<A> которая считай не связанна с этой хуитой
*/
